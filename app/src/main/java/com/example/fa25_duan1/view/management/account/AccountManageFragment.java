    ...
    public class AccountManageFragment extends Fragment {
        ...
        private void deleteUser(User user) {
            ...
            // Sửa tên file thành "MyPrefs" và key thành "userId" cho khớp với LoginFragment
            ...
            // Nếu ID của user muốn xóa == ID đang đăng nhập -> Chặn lại
            if (user.getUserID().equals(currentUserId)) {
                FancyToast.makeText(getContext(),
                        ...
                        FancyToast.ERROR,
                        false).show();
                return; // Dừng hàm, không hiện dialog xóa
            }

            // --- BƯỚC 3: HIỆN DIALOG XÓA (NẾU KHÔNG TRÙNG) ---
